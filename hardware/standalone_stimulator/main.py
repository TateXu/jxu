...
# Name       : main.py
# Version    : V1.0
# Description: Controller toolbox
#========================================
import numpy as np
import time
...
class MainWindow(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (tACSWindow, tDCSWindow):
            page_name = F.__name__
            frame = F(window=window, base_class=self)
...
class tDCSWindow(tk.Frame):
    def __init__(self, window, fontsize=20, base_class=None):
        self.window = window
    ...
    def button_place(self):
        ...
        self.bt_tACS = tk.Button(self.window, text="tACS", command=lambda: self.base_class.show_frame('tACSWindow'))
        self.bt_tDCS = tk.Button(self.window, text="tDCS", command=lambda: self.base_class.show_frame('tDCSWindow'))
        ...
        self.bt_tACS.grid(row=0, column=4)
        self.bt_tDCS.grid(row=1, column=4)
...
#         photo = 'Figures/button1.jpeg'
    ...
    def button_switch(self):
        ...
        b2=tk.Button(self.window,text="Capture",command=change_pic)
        b2.pack()
