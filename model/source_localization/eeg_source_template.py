...
epochs = mne.Epochs(raw, events, event_id=[44], baseline=None)
...
# evoked.data = np.tile()
evoked.data = np.tile(IC, (701, 1)).T
stc = mne.minimum_norm.apply_inverse(evoked, inv)
brain = stc.plot(subjects_dir=subjects_dir, initial_time=0.1, hemi='split', size=(1600, 800), title='IC1')
import pdb;pdb.set_trace()
