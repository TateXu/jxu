...
class MixOptimizer():
    ...
    def __init__(self, parameters, optimizer=torch.optim.SGD, lr=1e-2, *args, **kwargs):
        ...
        self.stiefel_parameters = [
            param for param in parameters if param.__class__.__name__ == 'StiefelParameter']
        self.stiefel_block_parameters = [
            param for param in parameters if param.__class__.__name__ == 'StiefelBlockParameter']
        self.spd_parameters = [
            param for param in parameters if param.__class__.__name__ == 'SPDParameter']
        self.weight_vector_parameters = [
            param for param in parameters if param.__class__.__name__ == 'WeightVectorParameter']
        self.other_parameters = [
            param for param in parameters if param.__class__.__name__ == 'Parameter']
