...
def radar(data_loader):
    ...
    if not Path(data_path).is_dir():
        ...
        print("Please download and extract the file at the following url: http://www-connex.lip6.fr/~schwander/datasets/radar.tgz")
        sys.exit(2)
    ...
    class RadarNet(nn.Module):
        def __init__(self):
            ...
            self.bimap1 = nn_spd.BiMap(1, 1, window_size, dim1)
        ...
        def forward(self, x):
            ...
            # x_spd=self.re(self.batchnorm1(self.bimap1(x_spd)))
            x_spd = self.re(self.bimap1(x_spd))
            # x_spd=self.batchnorm2(self.bimap2(x_spd))
...
if __name__ == "__main__":
    ...
    radar(DataLoaderRadar(data_path, pval, batch_size))
