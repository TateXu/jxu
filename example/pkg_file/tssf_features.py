...
class TSSF(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, clf_str='SVM', func='clf', n_components=None,
                 ...
                 ts_metric='riemann', bias_flag=False):
    ...
    def decision_function(self, X):
        ...
        # Please note that the intercept term can be safely ignored as long as adopting AIRM as the metric.
        if self.bias_flag:
            return X_ts.dot(self.beta) + self.bias
        else:
