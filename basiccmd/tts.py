...
def plain_tts(text, filename, file_root='/home/jxu/File/Data/NIBS/Stage_one/Audio/Others/',
              audio_rate=1.0, pitch=0.0, lang='en-US'):
    ssml_root = '<speak>', '</speak>'
    ssml_string = ssml_root[0] + text + ssml_root[1]
    try:
        google_text_to_speech(ssml_string, file_root + filename, speed=audio_rate, pitch=pitch, lang=lang)
    except:
